...
class BlogPost(db.Model):
    ...
    #Create Foreign Key relationship between User and BlogPost
    #The "author" refers to the author property in the User class.
    author_id: Mapped[int] = mapped_column(Integer, db.ForeignKey("users.id"))
    author = relationship("User", back_populates="posts")
    
    #Create a relationship between BlogPost and Comment (post property in Comment)
...
class User(UserMixin, db.Model):
    ...
    # Create a relationship between the User and BlogPost (author property in BlogPost)
    posts = relationship("BlogPost", back_populates="author")
    
    # Create a relationship between the User and Comment (author property in Comment)
...
class Comment(db.Model):
    ...
    # Create Foreign Key relationship between User and Comment
    author_id: Mapped[int] = mapped_column(Integer, db.ForeignKey("users.id"))
    author = relationship("User", back_populates="comments")
    # Create Foreign Key relationship between BlogPost and Comment
...
def show_post(post_id):
    ...
    if current_user.is_authenticated:
        ...
        if form.validate_on_submit():
            ...
            db.session.commit()
            return redirect(url_for("show_post", post_id=post_id, form=form, comments=requested_post.comments, current_user=current_user))
    else:
        form = None
